# Authentication System A backend authentication system built using Node.js, Express.js, MongoDB, and JWT. ## Features - User registration - Duplicate username/email validation - Password hashing - JWT-based authentication - Access token generation - Get current authenticated user - Refresh token functionality - MongoDB database integration - REST API development - API testing with Postman ## Technologies Used - Node.js - Express.js - MongoDB - JWT - bcrypt - dotenv - Postman ## Project Structure
text
